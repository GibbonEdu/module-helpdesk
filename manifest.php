...
$actionCount++ ;
$actionRows[$actionCount]["name"]="View issues_myWorking" ;
$actionRows[$actionCount]["precedence"]="2" ;
$actionRows[$actionCount]["category"]="" ;
$actionRows[$actionCount]["description"]= "Lists all active issues under my name that I am working on" ;
$actionRows[$actionCount]["URLList"]="issues_view.php" ;
$actionRows[$actionCount]["entryURL"]="issues_view.php" ;
$actionRows[$actionCount]["defaultPermissionAdmin"]="Y" ;
$actionRows[$actionCount]["defaultPermissionTeacher"]="N" ;
...
$actionCount++ ;
$actionRows[$actionCount]["name"]="View issues_allTechs" ;
$actionRows[$actionCount]["precedence"]="3" ;
$actionRows[$actionCount]["category"]="" ;
$actionRows[$actionCount]["description"]= "Lists all active issues that all Technicians are working on." ;
$actionRows[$actionCount]["URLList"]="issues_view.php" ;
$actionRows[$actionCount]["entryURL"]="issues_view.php" ;
$actionRows[$actionCount]["defaultPermissionAdmin"]="Y" ;
$actionRows[$actionCount]["defaultPermissionTeacher"]="N" ;
